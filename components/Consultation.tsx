        ...
        <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <p className="mt-5 text-lg text-ink-700">
              ...
              through your LADWP or SCE bill and your options in plain language.
            </p>
            <ul className="mt-7 space-y-3 text-ink-700">
              {[
                "100% free, with no obligation",
                "Talk to a local team — English, Spanish, Armenian, or Persian",
                "Clear answers about your bill, not a hard sell",
              ].map((item) => (
          ...
          <div className="rounded-3xl border border-ink-900/10 bg-sun-50/40 p-6 shadow-xl shadow-ink-900/5 sm:p-8">
            <LeadForm />
          </div>
        </div>
      </div>
